...
// Wire contract for the BornoBit Local Print Agent. Deliberately duplicated from
// the agent codebase (BornoBit.PrintAgent.Core.Contracts) — the schemaVersion field
// and tolerant JSON keep the two deployables decoupled.
